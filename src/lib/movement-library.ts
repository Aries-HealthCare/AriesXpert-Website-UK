...
export const MOVEMENT_ARTICLES: KnowledgeArticle[] = [
  {
    ...
    readTime: "6 min read",
    author: "Elena Vance, PT, MSc.PT",
    authorCredentials: "Registered Physiotherapist, FCAMPT",
    summary: "Discover why not all back pain is sciatica, how intervertebral discs actually heal, and why early movement out-performs bed rest in Canadian clinical guidelines.",
    keyTakeaways: [
  ...
  },
  {
    ...
    readTime: "5 min read",
    author: "Marcus Thorne, PT, MPT",
    authorCredentials: "Registered Physiotherapist, CSCS",
  ...
  },
  {
    ...
    readTime: "7 min read",
    author: "Sophie Tremblay, PT, MSc.PT",
    authorCredentials: "Registered Physiotherapist",
    summary: "How prolonged forward-head posture strains the suboccipital nerve roots and practical strategies to set up your Canadian remote workspace.",
    keyTakeaways: [
