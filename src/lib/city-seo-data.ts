...
export const citySeoPages: CitySeoData[] = [
    ...
    },
    {
        ...
        metaDescription: 'HCPC chartered home physiotherapy in Glasgow City Centre, West End, Southside, Bearsden & Milngavie. Direct insurer billing to Bupa, AXA Health & Aviva.',
        keywords: ['physiotherapy in glasgow', 'home physio glasgow', 'chartered physio scotland', 'physiotherapy west end glasgow'],
        heroHeading: 'In-Home Physiotherapy in Glasgow',
        heroSubheading: 'Specialized orthopaedic, spine, and neuro recovery delivered to your residence across Glasgow and the Clyde Valley.',
        localIntro: 'Our Glasgow chartered physiotherapists bring clinical-standard mobility and pain rehabilitation directly into your home, avoiding hospital commute delays.',
        whySection: 'Registered with HCPC and CSP, offering same-day appointments and direct billing to all major UK private health insurers.',
        stats: [
            { label: 'Active Clinicians in Glasgow', value: '28+' },
            { label: 'Clyde Valley Zones', value: '11+' },
            { label: 'Private Insurer Recognition', value: '100%' },
            { label: 'Avg. Patient Rating', value: '4.9★' },
        ],
        popularAreas: [
        ...
        conditions: ['Spinal Disc & Sciatica', 'Knee & Hip Joint Rehab', 'Sports Injury Recovery', 'Neurological Stroke Care'],
        faqs: [
            { question: 'Do you cover areas outside Glasgow city centre like Bearsden and Newton Mearns?', answer: 'Yes, our mobile clinicians provide complete coverage across Greater Glasgow, Dunbartonshire, and East Renfrewshire.' }
        ],
    ...
    },
    {
        ...
        metaTitle: 'Chartered In-Home Physiotherapy in Leeds & West Yorkshire | AriesXpert UK',
        metaDescription: 'Expert HCPC registered home physiotherapy in Leeds City Centre, Headingley, Roundhay & Horsforth. Direct billing for Bupa, AXA & Aviva.',
        keywords: ['physiotherapy in leeds', 'home physio leeds', 'chartered physio yorkshire', 'physiotherapy headingley'],
        heroHeading: 'In-Home Physiotherapy in Leeds',
        heroSubheading: 'Hospital-grade musculoskeletal and post-op physical rehabilitation delivered to your home across Leeds and West Yorkshire.',
        localIntro: 'Whether recovering from orthopaedic surgery or managing chronic lumbar pain, our Leeds chartered physiotherapists provide structured home recovery programs.',
        whySection: 'Statutory HCPC and CSP registration, enhanced DBS clearance, and direct settlement with UK health insurance providers.',
        stats: [
            { label: 'Active Clinicians in Leeds', value: '25+' },
            { label: 'West Yorkshire Hubs', value: '10+' },
            { label: 'Same-Day Assessment', value: 'Yes' },
            { label: 'Avg. Patient Rating', value: '4.8★' },
        ],
        popularAreas: [
            { name: 'Leeds City Centre', slug: 'leeds-city-centre' },
            { name: 'Headingley & Roundhay', slug: 'headingley-roundhay' },
        ],
        conditions: ['Lumbar Spondylosis', 'Total Knee Replacement (TKR)', 'Rotator Cuff Tear', 'Whiplash & Neck Strain'],
        faqs: [
            { question: 'Can I claim private physiotherapy in Leeds through Bupa or AXA?', answer: 'Yes, we settle directly with Bupa, AXA Health, Aviva, Vitality, and WPA via Healthcode electronic clearing.' }
        ],
    ...
    },
    {
        ...
        metaTitle: 'In-Home Physiotherapy in Bristol & Bath | AriesXpert UK',
        metaDescription: 'Top-rated chartered physiotherapy delivered to your home in Clifton, Redland, Harbourside & Bath. HCPC and CSP accredited specialists.',
        keywords: ['physiotherapy in bristol', 'home physio bristol', 'physio clifton', 'physiotherapy bath'],
        heroHeading: 'In-Home Physiotherapy in Bristol',
        heroSubheading: 'Evidence-based chartered physiotherapy delivered to your doorstep in Clifton, Harbourside, Redland, and Bath.',
        localIntro: 'Restore pain-free movement with personalized clinical physical therapy delivered in the comfort of your Bristol or Bath residence.',
        whySection: 'Direct billing with all major private medical insurers and verified HCPC clinical practitioners.',
        stats: [
            { label: 'Active Clinicians in Bristol', value: '22+' },
            { label: 'Avon & Somerset Zones', value: '8+' },
        ...
        conditions: ['Sports & Running Injuries', 'Spine & Sciatic Nerve Pain', 'Post-Op Shoulder Surgery', 'Senior Mobility Support'],
        faqs: [
            { question: 'How do home visits work in Bristol?', answer: 'Your chartered physiotherapist brings all diagnostic and therapeutic equipment. Sessions include clinical assessment, hands-on treatment, and guided rehabilitation.' }
        ],
    ...
    },
    {
        ...
        keywords: ['physiotherapy in cardiff', 'home physio cardiff', 'chartered physio wales', 'physio cardiff bay'],
